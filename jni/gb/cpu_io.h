...
{ 
	// 赤外線
/*probably infrared, so dont bother
	int bit, size;
...
{ 
	byte ret ;
		/*if (cg_regs.BCPS&1)
			ret= GBCOL_READ_565_HIGHER_BYTE(lcd_get_pal((cg_regs.OCPS>>3)&7, (cg_regs.OCPS>>1)&3));
		else
			ret= GBCOL_READ_565_LOWER_BYTE(lcd_get_pal((cg_regs.OCPS>>3)&7, (cg_regs.OCPS>>1)&3));*/
...
{ 
	byte ret ;
		...
		/*if (cg_regs.BCPS&1)
			ret= GBCOL_READ_565_HIGHER_BYTE(lcd_get_pal((cg_regs.BCPS>>3)&7, (cg_regs.BCPS>>1)&3));
		else
			ret= GBCOL_READ_565_LOWER_BYTE(lcd_get_pal((cg_regs.BCPS>>3)&7, (cg_regs.BCPS>>1)&3));*/
...
{ 
		/*if (cg_regs.BCPS&1){
			lcd_set_pal( ((cg_regs.BCPS>>3)&7)+8, (cg_regs.BCPS>>1)&3, GBCOL_WRITE_565_HIGHER_BYTE(dat, lcd_get_pal( ((cg_regs.BCPS>>3)&7)+8, (cg_regs.BCPS>>1)&3 ) ));
		}
		else{
			lcd_set_pal( ((cg_regs.BCPS>>3)&7)+8, (cg_regs.BCPS>>1)&3, GBCOL_WRITE_565_LOWER_BYTE(dat, lcd_get_pal( ((cg_regs.BCPS>>3)&7)+8, (cg_regs.BCPS>>1)&3 ) ));
		}  */
...
{ 
		/*if (cg_regs.OCPS&1){
			//lcd_set_pal( ((cg_regs.OCPS>>3)&7)+8, (cg_regs.OCPS>>1)&3, (lcd_get_pal( ((cg_regs.OCPS>>3)&7)+8, (cg_regs.OCPS>>1)&3 ) &0xff)|(dat<<8));
			lcd_set_pal( ((cg_regs.OCPS>>3)&7)+8, (cg_regs.OCPS>>1)&3, GBCOL_WRITE_565_HIGHER_BYTE(dat, lcd_get_pal( ((cg_regs.OCPS>>3)&7)+8, (cg_regs.OCPS>>1)&3 ) ));

		}
		else{
			lcd_set_pal( ((cg_regs.OCPS>>3)&7)+8, (cg_regs.OCPS>>1)&3, GBCOL_WRITE_565_LOWER_BYTE(dat, lcd_get_pal( ((cg_regs.OCPS>>3)&7)+8, (cg_regs.OCPS>>1)&3 ) ));
		}*/
		if (cg_regs.OCPS&1){
